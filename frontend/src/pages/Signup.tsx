  ...
  return (
    <div className="grid min-h-screen place-items-center bg-slate-950 px-4 text-white">
      <div className="w-full max-w-md rounded-lg border border-white/10 bg-white/5 p-6 shadow-2xl">
        ...
        <p className="mt-2 text-sm text-slate-300">Start with the complete CreateX toolkit.</p>
        <div className="mt-6 space-y-4">
          <input className="h-12 w-full rounded-lg border border-white/10 bg-slate-950 px-4 text-sm outline-none focus:border-blue-500" placeholder="Full name" />
        ...
        <p className="mt-5 text-sm text-slate-300">
          Already have an account? <Link className="font-bold text-blue-300" to="/login">Login</Link>
        </p>
      </div>
    </div>
  );
